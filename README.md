...
- The game limits the number of attempts.
- Multiple rounds are supported.
- A score is calculated based on the number of attempts taken.
...
4. Added attempt limitation and scoring system.
5. Tested the program for multiple rounds.
6. Prepared the project for GitHub submission.
